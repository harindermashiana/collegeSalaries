...
```{r}
degrees_that_pay_back <- read.csv("data//degrees-that-pay-back.csv")

salaries_by_college_type <- read.csv("data//salaries-by-college-type.csv")
  
salaries_by_region <- read.csv("data//salaries-by-region.csv")
```
